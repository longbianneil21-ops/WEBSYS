  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .admin-section {
      ...
      padding: 24px 36px; border-left: 4px solid #d97706;
      display: none;
    }
    .admin-section.show { display: block; }
    .admin-section h3 { margin: 0 0 14px; font-size: 16px; font-weight: 800; color: #92400e; }
    .admin-section p { margin: 0 0 16px; color: #b45309; font-size: 14px; }
    .admin-btn {
...
<div class="app-shell">
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav" aria-label="Dashboard navigation">
      ...
      <a href="SchoolSched.php" class="nav-item"><span class="nav-item-icon">📋</span>Class Schedule</a>
      ...
      <a href="account.php"     class="nav-item active"><span class="nav-item-icon">👤</span>Account</a>
    </nav>
  ...
  <main class="main-area">
    ...
    <div class="account-card">
      ...
      <div class="admin-section" id="adminSection">
        ...
        <p>You have administrative privileges. Access administrative functions below:</p>
        <a href="admin-class-schedule.php" class="admin-btn">📚 Manage Class Schedule</a>
      </div>
